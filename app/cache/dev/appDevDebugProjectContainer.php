...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['dcs_rating.manager.rating.default'] = new \DCS\RatingBundle\Entity\RatingManager($this->get('debug.event_dispatcher'), $this->get('doctrine.orm.default_entity_manager'), 'Esprit\\DarkomBundle\\Entity\\Rating');
    }
    ...
    {
        return $this->services['dcs_rating.manager.vote.default'] = new \DCS\RatingBundle\Entity\VoteManager($this->get('debug.event_dispatcher'), $this->get('doctrine.orm.default_entity_manager'), 'Esprit\\DarkomBundle\\Entity\\Vote');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'darkom', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\Esprit\\DarkomBundle\\Resources\\config\\doctrine') => 'Esprit\\DarkomBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\doctrine') => 'FOS\\UserBundle\\Entity', ($this->targetDirs[3].'\\vendor\\damianociarla\\rating-bundle\\DCS\\RatingBundle\\Resources\\config\\doctrine') => 'DCS\\RatingBundle\\Entity'));
        $b->setGlobalBasename('mapping');

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($a, 'Esprit\\DarkomBundle\\Entity');
        $c->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Esprit\\UserBundle\\Entity'))), 'Esprit\\UserBundle\\Entity');
        $c->addDriver($b, 'FOS\\UserBundle\\Entity');
        $c->addDriver($b, 'DCS\\RatingBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('EspritDarkomBundle' => 'Esprit\\DarkomBundle\\Entity', 'EspritUserBundle' => 'Esprit\\UserBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'DCSRatingBundle' => 'DCS\\RatingBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9da744ba416120917ab7fa1482baf89c56941e2db2f5f835fd79d7edf767f556');
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\TwigSwiftMailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('twig'), array('template' => array('confirmation' => 'EspritUserBundle:Registration:registration.email.twig', 'resetting' => 'FOSUserBundle:Resetting:email.txt.twig'), 'from_email' => array('confirmation' => array('admdarkom@gmail.com' => 'Admin de Darkom'), 'resetting' => array('webmaster@example.com' => 'webmaster'))));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Esprit\UserBundle\Redirection\AfterLoginRedirection A Esprit\UserBundle\Redirection\AfterLoginRedirection instance.
     */
    protected function getRedirect_After_LoginService()
    {
        return $this->services['redirect.after.login'] = new \Esprit\UserBundle\Redirection\AfterLoginRedirection($this->get('router'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/Annonceur');
        ...
        $n->add($k, array(0 => 'ROLE_CLIENT'), NULL);
        $n->add($l, array(0 => 'ROLE_ANNONCEUR'), NULL);
        $n->add($m, array(0 => 'ROLE_ADMIN'), NULL);

        $o = new \Symfony\Component\Security\Http\HttpUtils($e, $e);

        $p = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'ThisTokenIsNotSoSecretChangeIt', 'main', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $q = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $o, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($o, '/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        ...
        $s = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, $this->get('security.authentication.session_strategy'), $o, 'main', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('redirect.after.login'), array('always_use_default_target_path' => false, 'default_target_path' => '/', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false), 'main'), $r, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $d, $this->get('security.csrf.token_manager'));
        $s->setRememberMeServices($p);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($n, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'main', $a, $d), 2 => $q, 3 => $s, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $p, $g, $a, $d, true), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '576822b42252d9.82706183', $a, $g), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $n, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $o, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $o, '/login', false), '/erreur', NULL, $a));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('admdarkom@gmail.com');
        $a->setPassword('darkom2015');
        $a->setAuthMode(NULL);
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Esprit\\DarkomBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Esprit\\FrontBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Esprit\\GraphBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Esprit\\DarkomBundle/Resources/views'), 'EspritDarkom');
        $instance->addPath(($this->targetDirs[3].'\\src\\Esprit\\UserBundle/Resources/views'), 'EspritUser');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Esprit\\FrontBundle/Resources/views'), 'EspritFront');
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Esprit\\GraphBundle/Resources/views'), 'EspritGraph');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ANNONCEUR' => array(0 => 'ROLE_USER'), 'ROLE_CLIENT' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'EspritDarkomBundle' => 'Esprit\\DarkomBundle\\EspritDarkomBundle',
                'EspritUserBundle' => 'Esprit\\UserBundle\\EspritUserBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'EspritFrontBundle' => 'Esprit\\FrontBundle\\EspritFrontBundle',
                ...
                'EspritGraphBundle' => 'Esprit\\GraphBundle\\EspritGraphBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'darkom',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'gmail',
            'mailer_host' => NULL,
            'mailer_user' => 'admdarkom@gmail.com',
            'mailer_password' => 'darkom2015',
            'locale' => 'fr',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'admdarkom@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'darkom2015',
            ...
            'fos_user.registration.confirmation.template' => 'EspritUserBundle:Registration:registration.email.twig',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'admdarkom@gmail.com' => 'Admin de Darkom',
            ),
            ...
            'dcs_rating.model.rating.class' => 'Esprit\\DarkomBundle\\Entity\\Rating',
            'dcs_rating.model.vote.class' => 'Esprit\\DarkomBundle\\Entity\\Vote',
